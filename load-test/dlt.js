 ...
 * ------------------------------------------------------------
 * 목적:
 * - Consumer 예외 발생 시 Dead Letter Topic 적재 확인
 * - 정상 메시지 처리 흐름과 분리 검증
 *
 * 전제:
 * - "FORCE_ERROR" 포함 시 consumer에서 RuntimeException 발생
 * - Kafka DLT topic 구성 완료 상태
 * ============================================================
 */
...
export function setup() {
  console.log('===== DLT TEST START =====');
  console.log('▶ FORCE_ERROR payload 전송');
  console.log('▶ DLT topic 적재 여부 확인');
}
