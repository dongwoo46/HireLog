  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pt-24 pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-gray-400 hover:text-gray-600 mb-8"
        >
          <TbChevronLeft size={20} />
          뒤로가기
        </button>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="p-8 md:p-12 border-b bg-[#4CDFD5]/10">
            <h1 className="text-3xl font-black text-gray-900 mb-2">
              새로운 JD 요약 요청
            </h1>
            <p className="text-gray-500">
              공고 정보를 입력하면 핵심 내용을 정리해드립니다.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-8">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-[#4CDFD5] hover:bg-[#3CCFC5] active:bg-[#35C3BA] text-white font-black text-xl rounded-2xl transition-all disabled:opacity-50"
            >
...
const TabButton: React.FC<{
  ...
  <button
    ...
    className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all ${active
        ? 'bg-white text-[#4CDFD5] shadow-sm'
