...
//             <Link to="/history" className="flex items-center text-gray-500 hover:text-gray-800 text-sm font-medium">
...
//           {/* Submit Button */}
//           <div className="flex flex-col items-center pt-8 pb-20 gap-4">
//             {error && (
//               <p className="text-sm font-bold text-rose-500 animate-pulse bg-rose-50 px-4 py-2 rounded-lg">
//                 {error}
//               </p>
//             )}
//             <button
